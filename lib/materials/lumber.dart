...
class Lumber extends StatefulWidget {
  const Lumber({super.key});

  @override
  State<Lumber> createState() => _LumberState();
}

class _LumberState extends State<Lumber> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: StreamBuilder<List<MaterialModel>>(
          stream: apiService.getMaterials("Lumber").asStream(),
