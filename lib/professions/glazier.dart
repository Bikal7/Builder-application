...
import '../Add Info/editProfession.dart';
import '../bloc/apiservices/apiImpl.dart';
import '../bloc/apiservices/apiService.dart';
import 'package:url_launcher/url_launcher.dart';


class Glazier extends StatefulWidget {
  const Glazier({super.key});

  @override
  State<Glazier> createState() => _GlazierState();
}

class _GlazierState extends State<Glazier> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: StreamBuilder<List<ProfeesionModel>>(
          stream: apiService.getProfessions("Glazier").asStream(),
